...
exports.showThreadsbyId = showThreadsbyId;
exports.showThreadsbyUsername = showThreadsbyUsername;
...
exports.showCommentsById = showCommentsById;
const client_1 = require("@prisma/client");
const cloudinary_1 = __importDefault(require("../services/cloudinary"));
const prisma = new client_1.PrismaClient();
async function showThreads(req, res) {
    ...
    try {
        ...
        const sanitizedThreads = threadsWithLikeStatus.map(({ likes, ...rest }) => rest);
        return res.json({
...
async function showThreadsbyId(req, res) {
    const { id } = req.params;
    const userId = req.user.id;
    try {
...
async function showThreadsbyUsername(req, res) {
...
async function deleteThread(req, res) {
    ...
    try {
        ...
        if (checkThreads.authorId !== req.user.id) {
            return res
                .status(401)
...
async function showCommentsById(req, res) {
    const { threadId, commentId } = req.params;
